    ...
    import com.awsomeproject.remote.RemoteConst;
        ...
        private static class CommandRunnable implements Runnable{
            ...
            public void run() {
                ...
                try {
                    ...
                    //发送命令内容
                    Bitmapsender sender=new Bitmapsender();
                    Bitmap bitmap= Bitmap.createBitmap(sender.createColors(250000), 500, 500, Bitmap.Config.RGB_565);
                    sender.writeBitmap(os,bitmap);
